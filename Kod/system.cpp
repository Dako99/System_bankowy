...
void Uzytkownik::dodaj()	//dodaje użytkownika do systemu
{
	...
	do
	{
		...
		//ROCZNIK 00 and up
		//Osoby urodzone w roku 2000 i później mają powiększony numer miesiąca o liczbę 20
...
{	//kwota			//jeżeli użytkownik ma kilka kont, to spytac na ktore konto
	float wplata;
...
//Wrzucam tylko tę funkcje, dzisiaj nocka zarwana i praktycznie 0 progresu :(
...
// Plus jeszcze ta, ale tutaj wywala mi błąd przeładowania bufora i nie wiem co dalej, problem prawdopodobnie,
//leży w pętli.
